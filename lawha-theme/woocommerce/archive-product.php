...
?>
  ...
  <section class="cta-banner" id="cta">
    ...
    <div class="cta-banner__content anim-fade-up">
      <p class="overline mb-4" style="color: var(--accent-light);"><?php esc_html_e( "Can't Decide?", 'lawha' ); ?></p>
      ...
      <a href="<?php echo esc_url( 'https://wa.me/' . lawha_get_whatsapp_number() ); ?>" class="btn btn--whatsapp">
