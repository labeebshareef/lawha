      ...
      <div class="container">
        <div class="product-detail">
          ...
          <div class="product-detail__info anim-fade-up">
            ...
            <!-- WhatsApp Order -->
            <a href="<?php echo esc_url( 'https://wa.me/' . lawha_get_whatsapp_number() . '?text=' . rawurlencode( 'Hi LAWHA! I\'d like to order: ' . $product->get_name() ) ); ?>" class="btn btn--whatsapp" style="width: 100%; margin-top: var(--space-3);">
