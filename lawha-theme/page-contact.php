...
?>
  ...
  <section class="section" id="contact-info">
    <div class="container">
      ...
      <div class="grid grid--3 stagger-children mb-8">
        <!-- WhatsApp -->
        <a href="<?php echo esc_url( 'https://wa.me/' . lawha_get_whatsapp_number() ); ?>" class="contact-info-card anim-fade-up hover-lift no-underline">
          ...
          <div>
            ...
            <p class="contact-info-card__text"><?php echo esc_html( lawha_get_contact_phone() ); ?><br><?php esc_html_e( 'Fastest way to order', 'lawha' ); ?></p>
          </div>
        </a>

        <!-- Phone -->
        <a href="tel:<?php echo esc_attr( lawha_get_contact_phone() ); ?>" class="contact-info-card anim-fade-up hover-lift no-underline">
          <div class="contact-info-card__icon">
          ...
          <div>
            ...
            <p class="contact-info-card__text"><?php echo esc_html( lawha_get_contact_phone() ); ?><br><?php esc_html_e( 'Sun — Thu, 9am — 6pm', 'lawha' ); ?></p>
          </div>
        </a>

        <!-- Email -->
        <a href="mailto:<?php echo esc_attr( lawha_get_contact_email() ); ?>" class="contact-info-card anim-fade-up hover-lift no-underline">
          <div class="contact-info-card__icon">
          ...
          <div>
            ...
            <p class="contact-info-card__text"><?php echo esc_html( lawha_get_contact_email() ); ?><br><?php esc_html_e( 'We reply within 24 hours', 'lawha' ); ?></p>
          </div>
        </a>
      </div>
      ...
      <div class="text-center anim-fade-up">
        <a href="<?php echo esc_url( 'https://wa.me/' . lawha_get_whatsapp_number() . '?text=Hi%20LAWHA!%20I%27d%20like%20to%20place%20an%20order.' ); ?>" class="btn btn--whatsapp" style="font-size: var(--text-sm); padding: var(--space-4) var(--space-7);">
    ...
    <div class="container">
      <div class="contact-grid">
        <div class="anim-fade-up">
          <p class="overline mb-4"><?php esc_html_e( 'Send a Message', 'lawha' ); ?></p>
          <h3 class="mb-5"><?php esc_html_e( "We'd Love to Hear From You", 'lawha' ); ?></h3>
          <p class="mb-6"><?php esc_html_e( 'Have a question, want to collaborate, or simply want to say hello? Fill out the form and our team will get back to you shortly.', 'lawha' ); ?></p>
          <form id="contactForm" method="post" action="">
            ...
            <div class="form-group">
              ...
              <input type="email" id="email" name="email" class="form-input" placeholder="<?php esc_attr_e( 'your@email.com', 'lawha' ); ?>" value="<?php echo isset( $data['email'] ) ? esc_attr( $data['email'] ) : ''; ?>" required>
            </div>
            <div class="form-group">
              <label for="subject" class="form-label"><?php esc_html_e( 'Subject', 'lawha' ); ?></label>
              <input type="text" id="subject" name="subject" class="form-input" placeholder="<?php esc_attr_e( 'How can we help?', 'lawha' ); ?>" value="<?php echo isset( $data['subject'] ) ? esc_attr( $data['subject'] ) : ''; ?>">
            </div>
            <div class="form-group">
              <label for="message" class="form-label"><?php esc_html_e( 'Message', 'lawha' ); ?></label>
              <textarea id="message" name="message" class="form-textarea" placeholder="<?php esc_attr_e( 'Tell us more...', 'lawha' ); ?>" required><?php echo isset( $data['message'] ) ? esc_textarea( $data['message'] ) : ''; ?></textarea>
            </div>
            <button type="submit" class="btn btn--primary"><?php esc_html_e( 'Send Message', 'lawha' ); ?> <span class="btn__arrow">→</span></button>
          </form>
        </div>

        <div class="anim-fade-up pl-7">
          <p class="overline mb-4"><?php esc_html_e( 'Follow Us', 'lawha' ); ?></p>
          <h3 class="mb-5"><?php esc_html_e( 'Stay Connected', 'lawha' ); ?></h3>
          <p class="mb-6"><?php esc_html_e( 'Follow us on social media for the latest collections, styling tips, and behind-the-scenes content.', 'lawha' ); ?></p>
          <div class="flex flex-col gap-4">
            <a href="#" class="contact-info-card hover-lift no-underline">
              <div class="contact-info-card__icon">
